...
class RESIDE_Dataset(data.Dataset):
    ...
    def augData(self,data,target,haze_4,clear_4):
        ...
        if a1%16!=0:
            a1_=(a1//16+1)*16
            data=tfs.Pad((a1_-a1,0,0,0),fill=0,padding_mode='constant')(data)
           
        if a2%16!=0:
            a2_=(a2//16+1)*16
            data=tfs.Pad((0,0,0,a2_-a2),fill=0,padding_mode='constant')(data)
        if b1%16!=0:
            b1_=(b1//16+1)*16
            target=tfs.Pad((b1_-b1,0,0,0),fill=0,padding_mode='constant')(target)
        if b2%16!=0:
            b2_=(b2//16+1)*16
            target=tfs.Pad((0,0,0,b2_-b2),fill=0,padding_mode='constant')(target)
